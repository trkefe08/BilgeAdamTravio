...
final class HomeTVC: UITableViewCell {
    ...
    private lazy var collectionView: UICollectionView = {
        ...
        cv.register(HomeCVC.self, forCellWithReuseIdentifier: "HomeCollectionViewCell")
        return cv
    }()
    //MARK: - Variables
...
extension HomeTVC: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "HomeCollectionViewCell", for: indexPath) as? HomeCVC else { return UICollectionViewCell() }
